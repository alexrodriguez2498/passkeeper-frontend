export const DynamicAsideMenuConfig = {
  items: [
    ...
    },
    {
      ...
      icon: 'flaticon2-architecture-and-city',
      svg: './assets/media/svg/icons/Design/Layers.svg',
      page: '/passport-documents',
      translate: 'MENU.PASSPORT_AND_DOCUMENTS',
      bullet: 'dot',
    },
    {
      ...
      icon: 'flaticon2-architecture-and-city',
      svg: './assets/media/svg/icons/Design/Layers.svg',
      page: '/messaging-accounts',
      translate: 'MENU.MESSAGING_APPS',
      bullet: 'dot',
    },
    {
      title: 'Dashboard',
    ...
    { section: 'Premium' },
    {
      ...
      translate: 'PREMIUM.SECURITY_DASHBOARD',
      bullet: 'dot',
    },
    {
      ...
      svg: './assets/media/svg/icons/Design/Layers.svg',
      page: '/sharing-center',
      translate: 'PREMIUM.SHARING_CENTER',
      bullet: 'dot',
    },
    {
      ...
      translate: 'PREMIUM.EMERGENCY_ACCESS',
      bullet: 'dot',
    },
    {
      ...
      svg: './assets/media/svg/icons/Design/Layers.svg',
      page: '/settings',
      translate: 'PREMIUM.ACCOUNT_SETTINGS',
      bullet: 'dot',
    },
    {
      ...
      translate: 'PREMIUM.ADVANCE_OPTIONS',
      bullet: 'dot',
    },
    {
      title: 'Help ',
