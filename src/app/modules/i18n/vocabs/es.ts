...
export const locale = {
  ...
  data: {
    ...
    MENU: {
      ...
      PASSPORT_AND_DOCUMENTS: 'Pasaportes y Documentos',
      MESSAGING_APPS: 'Apps de Mensajeria'
    },
    PREMIUM: {
      SECURITY_DASHBOARD: 'Tablero de Seguridad',
      SHARING_CENTER: 'Centro Compartido',
